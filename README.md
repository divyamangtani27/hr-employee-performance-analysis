...
This project taught me things apart from the lectures:

- **Data Loading** — reading a real CSV and understanding what you're actually looking at before touching anything
...
- **Label Encoding** — converting categories like gender and recruitment channel into numbers a model can work with
